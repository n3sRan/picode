...
import { DEFAULT_MAX_LLM_REQUESTS as DEFAULT_CONFIG_MAX_LLM_REQUESTS } from "../config.js";

export const DEFAULT_MAX_LLM_REQUESTS = DEFAULT_CONFIG_MAX_LLM_REQUESTS;
